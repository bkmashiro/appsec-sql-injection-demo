...
<template>
  ...
  <div class="grid grid-cols-3 gap-4 p-4">
    ...
    <div class="col-span-2 grid grid-rows-2 gap-4">
      <div class="bg-gray-100 p-4 rounded">
        ...
        <button @click="executeQuery"
                class="mt-2 bg-green-500 text-white p-2 rounded">Execute</button>
      </div>
      <div class="bg-gray-100 p-4 rounded">
    ...
    <footer class="mt-4 p-4 text-sm text-gray-600">
      <p><strong>Disclaimer:</strong> This application is a fully frontend-based demo for educational purposes only. It
      ...
      <p><strong>Repository:</strong> <a href="https://github.com/bkmashiro/appsec-sql-injection-demo"
           class="text-blue-500"
           target="_blank">bkmashiro</a></p>

      <p>This project is a part of Application Security group project presentation by <a href="https://blog.yuzhes.com/"
           class="text-blue-500"
